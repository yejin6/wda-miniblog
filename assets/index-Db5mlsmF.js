...
`;function z9(n){const{post:e}=n;return $.jsxs(N9,{children:[$.jsx(O9,{children:e.category}),$.jsx(k9,{children:e.title}),$.jsxs(V9,{children:[$.jsx("p",{children:"yeahz"}),$.jsx("img",{src:"/wda-miniblog/dot.svg",alt:"img"}),e.time||"시간"]}),$.jsx(M9,{children:$.jsx("img",{src:e.image,alt:""})}),$.jsx(L9,{children:e.content}),$.jsx(U9,{children:e.hashtags&&e.hashtags.map(t=>$.jsxs("span",{children:["# ",t]},t))})]})}const B9=_e.div`
  display: flex;
  flex-direction: column;
